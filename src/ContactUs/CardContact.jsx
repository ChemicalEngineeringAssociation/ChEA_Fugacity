...
const CardContact = (props) => {
  return (
    <div className=" cardParent relative h-[400px] w-[320px] ">
      <div className="frontFace card absolute h-full w-full p-2 bg-[#031b30] rounded-lg">
        <img
          loading="lazy"
      ...
      <div className="backFace text-center card absolute h-full w-full p-2 bg-[#031b30] rounded-lg">
        <img
          loading="lazy"
          className="h-[150px] w-[150px] p-1 rounded-full bg-white" 
          src={props.url}
          alt="img"
        />
        ...
        <h3 className="text-lg text-slate-200 text-center">
          +91-{props.phone}
        </h3>
