          ...
          <div className="p-4 md:p-10 text-slate-400 font-avenir text-md">
            <div className=" text-justify">
              <p>
                ...
                Industry Experts and emerging Researchers will grace the fest
                will their insightful lectures and warm presence. We cordially
                invite you to our fest and request you to support our endeavours
              </p>
            </div>
          </div>
        </div>
